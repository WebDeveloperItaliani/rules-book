...
Nell'ottica di una community coesa e per non limitare la comunicazione professionale tra gli utenti, sono permessi i contenuti `Off-Topic` strettamente riguardanti l'ambito di sviluppo: hardware, postazioni da lavoro, ester-eggs, etc.
Negli Off-Topic permessi, si prega di usare il topic `Categoria: Off-Topic`, ed eventuali altri correlati.
Inoltre ogni Off-Topic con link a siti come amazon a cui è stato allegato un referral, verrà cancellato instantaneamente.
